...
// Define handlers that can be exported for use elsewhere
const signatureHandlers = {
  // Signature confirmation handler (for /confirm route)
...
module.exports.handlers = signatureHandlers;